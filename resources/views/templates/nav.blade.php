  ...
  <aside class="left-sidebar">
    ...
    <nav class="sidebar-nav">
      <ul id="sidebarnav">
        ...
        <li>
          <a href="{{route('av-test')}}" aria-expanded="false"><i class="fa fa-circle"></i><span class="hide-menu">Examenes</span></a>
        </li>
        <li>
          <a href="{{route('course')}}" aria-expanded="false"><i class="fa fa-circle"></i><span class="hide-menu">Cursos</span></a>
        </li>
        <li>
          <a href="{{route('performance')}}" aria-expanded="false"><i class="fa fa-circle"></i><span class="hide-menu">Rendimiento</span></a>
        </li>
      </ul>
    </nav>

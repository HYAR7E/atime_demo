            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header" style="margin:0;">
                    <a class="navbar-brand" href="{{ route('index') }}">
                        <img src="{{asset('/material-pro/assets/images/logo.png')}}" alt="homepage" class="light-logo" height="45px" /> <h2 class="main-title">ATIME</h2>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow" href="{{ route('index') }}" aria-expanded="false">
                                <i class="mdi mdi-file-document"></i><span class="hide-menu">Registro </span>
                            </a>
                            {{-- <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ route('index') }}">Según investigación</a></li>
                        ...
                        <li>
                           ...
                           {{--  <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ route('index') }}">Investigación (personas)</a></li>
                                @if(Auth::user()->rol=='0')
